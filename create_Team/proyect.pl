...
employee_skill(1,[azure,cloud,java,cpp,excel,python,prolog,db,c,teamwork,testing,attention,teamPlayer,problemSolving]).
employee_skill(2,[azure,cloud,java,cpp,excel,python,prolog,db,c,php,r,go,kotlin,teamwork,testing,attention,teamPlayer,problemSolving]).
employee_skill(3,[python,prolog,db,c,php,r,go,kotlin,teamwork,testing,attention,teamPlayer,problemSolving]).
employee_skill(4,[azure,cloud,java,db,c,php,r,go,kotlin,mathematical,teamwork,testing,attention,teamPlayer,problemSolving]).
employee_skill(5,[azure,cpp,excel,python,prolog,db,c,php,r,go,kotlin,mathematical,teamwork,testing,attention,teamPlayer,problemSolving]).
employee_skill(6,[azure,cloud,java,cpp,prolog,db,c,php,r,go,kotlin,mathematical,teamwork,testing,attention,teamPlayer,problemSolving]).
employee_skill(7,[azure,cloud,java,cpp,excel,python,c,php,r,go,kotlin,mathematical,teamwork,testing,attention,teamPlayer,problemSolving]).
employee_skill(8,[cloud,java,cpp,prolog,db,c,php,r,go,kotlin,mathematical,teamwork,testing,attention,teamPlayer,problemSolving]).
employee_skill(9,[azure,cloud,java,cpp,excel,python,prolog,db,c,php,r,mathematical,teamwork,testing,attention,teamPlayer,problemSolving]).

employee_skill(10,[azure,cloud,prolog,db,c,php,r,go,kotlin,mathematical,teamwork,testing,attention,teamPlayer,problemSolving]).
employee_skill(11,[azure,cloud,java,cpp,excel,python,mathematical,teamwork,testing,attention,teamPlayer,problemSolving]).
employee_skill(12,[azure,excel,python,prolog,db,c,php,r,go,kotlin,teamwork,testing,attention,teamPlayer,problemSolving]).
employee_skill(13,[cloud,java,cpp,python,db,c,php,r,go,kotlin]).
employee_skill(14,[cloud,java,cpp,excel,python,prolog,db,c,php,r,teamwork,testing,attention,teamPlayer,problemSolving]).
employee_skill(15,[azure,cloud,java,cpp,excel,python,prolog,db,c,php,softwareDesign,verbalCommunication,detailing,iis,noSQL,github]).
employee_skill(16,[r,go,kotlin,softwareDesign,verbalCommunication,detailing,iis,noSQL,github]).
employee_skill(17,[excel,prolog,db,c,php,kotlin,softwareDesign,verbalCommunication,detailing,iis,noSQL,github]).
employee_skill(18,[java,cpp,excel,python,php,r,go,softwareDesign,verbalCommunication,detailing,iis,noSQL,github]).
employee_skill(19,[azure,cloud,java,cpp,excel,prolog,db,r,go,kotlin,mathematical,teamwork,testing,attention,teamPlayer,problemSolving]).
employee_skill(20,[java,cpp,excel,db,c,php,r,go,kotlin,softwareDesign,verbalCommunication,detailing,iis,noSQL,github]).
employee_skill(21,[azure,cloud,java,cpp,excel,python,prolog,db,c,php,r,go,kotlin,mathematical,teamwork,testing,attention,teamPlayer,problemSolving]).
employee_skill(22,[cloud,java,cpp,python,prolog,c,php,r,go,kotlin,mathematical,teamwork,testing,attention,teamPlayer,problemSolving]).
employee_skill(23,[excel,python,prolog,db,c,php,r,go,kotlin,mathematical,teamwork,testing,attention,teamPlayer,problemSolving]).
employee_skill(24,[python,prolog,db,c,php,r,go,kotlin,mathematical,teamwork,testing,attention,teamPlayer,problemSolving]).
employee_skill(25,[azure,cloud,java,mathematical,teamwork,testing,attention,teamPlayer,problemSolving,softwareDesign,verbalCommunication,detailing,iis,noSQL,github]).

employee_skill(26,[azure,cloud,java]).
employee_skill(27,[python,prolog,db,c,php,r,go,kotlin,purescript,swift,dart]).
employee_skill(28,[cpp,excel,r,go,kotlin,purescript,swift,dart]).
employee_skill(29,[azure,cpp,prolog,db,purescript,swift,dart]).
employee_skill(30,[java,cpp,excel,python,prolog,db,c,php,r,go,kotlin,purescript]).
employee_skill(31,[azure,cloud,java,cpp,prolog,db,c,php,r,go,kotlin,purescript]).
employee_skill(32,[azure,cloud,java,cpp,excel,python,purescript]).
employee_skill(33,[azure,r,go,kotlin,swift,dart]).
employee_skill(34,[azure,cloud,java,cpp,excel,python,prolog,db,c,php,r,go,kotlin,purescript,swift,dart]).
employee_skill(35,[azure,python,prolog,db,c,php,r,go,kotlin,swift,dart]).
employee_skill(36,[cloud,java,cpp,excel,python,prolog,c,r,go,kotlin,purescript,swift,dart]).
employee_skill(37,[cloud,java,cpp,excel,db,c,php,r,go,kotlin,purescript,swift,dart]).
employee_skill(38,[cloud,java,cpp,excel,db,c,php,r,go,purescript,swift,dart]).
employee_skill(39,[cloud,db,c,php,r,go,kotlin,purescript,swift,dart]).
employee_skill(40,[azure,cloud,java,cpp,excel,purescript,swift,dart]).
...
project_id(prolog,777).
project_id(webapp,888).
project_id(videogames,989898).
...
project_requirements(33399,[drive,fly,fight,communication,development]).
%really hard project
...
%only the serniors and architects have these skills, the juniors dont
project_requirements(777,[mathematical,teamwork,testing,attention,teamPlayer,problemSolving]).
%only the juniors has those skills
project_requirements(888,[purescript,swift,dart]).
%only the juniors has those skills
project_requirements(989898,[softwareDesign,verbalCommunication,detailing,iis,noSQL,github,svn]).
...
employee_available(10,available).
...
employee_available(15,unavailable).
...
employee_available(20,available).
employee_available(21,unavailable).
employee_available(22,available).
employee_available(23,available).
employee_available(24,available).
employee_available(25,unavailable).
...
employee_available(31,unavailable).
employee_available(32,available).
employee_available(33,available).
employee_available(34,available).
employee_available(35,available).
employee_available(36,unavailable).
